...
In order to support loading of multiple wallets in wire-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wire.cpp.
...
Changes to wire.cpp
----------------------
wire.cpp is the entry point into wire-qt, and as such, will require some minor modifications to provide hooks for
